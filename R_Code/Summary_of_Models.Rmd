...
### Summary
```{r}
summarise_default(ai_spline_age)
```
...
###Summary
```{r }
summarise_default(ai_spline_age_day)
```
...
legend("topright", legend = c("SS", "HB"),lwd = 3,
               ...
               title = "Groups")
```
## splines a for day ai_spline_day
```{r}
source("helpfunctions.r")
