...
### prediction final 
```{r }
y_pred_ai <- get_params(c("y_pred"),beta_rand_rslope$samples)
data_to_exp <- data.frame(id = data$id, day = data$day, ai_pred = y_pred_ai)
```
...
ai_beta_sq_ti <- subset_coda_params(data = beta_rand$samples, variable = c("beta_age", "beta_day", "beta0","sigma_b0","phi","sigma_b1","sigma_b2"))
beta_rand$WAIC$WAIC
