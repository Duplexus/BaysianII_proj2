...
source("helpfunctions.r")
#beta 1 age beta2 day
beta_means <- get_params(c("beta0", "beta_age", "beta2","sigma_b0","phi"),ai_spline_age_day$samples)
#age and day are transformed therefore also here some transofrmation
age <- 22
day <- c(-6:22)
...
### with splines a for day and age
```{r}
source("helpfunctions.r")
#beta 1 age beta2 day
beta_means <- get_params(c("beta0", "beta_age", "beta_day","sigma_b0","phi"),beta_rand$samples)
#age and day are transformed therefore also here some transofrmation
age_orig <- 22
day_orig <- c(-6:22)
#works tryed it with the true data, if we would make a bigger project do a unit_test
